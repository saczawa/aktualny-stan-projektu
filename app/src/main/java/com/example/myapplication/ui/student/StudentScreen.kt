...
import com.example.myapplication.AddStudentDialog
...
//            AddStudentDialog(state = state, onEvent = onEvent)
//        }
//        LazyColumn(
...
//                            modifier = Modifier
//                                .clickable {
//                                    onEvent(StudentEvent.SortStudent(sortType))
//                                },
...
//                        fontSize = 20.sp
//                    )
//                    Text(text = student.phoneNumber, fontSize = 12.sp)
//                }
//                IconButton(onClick = {
//                    onEvent(StudentEvent.DeleteStudent(student))
//                }) {
//                    Icon(
